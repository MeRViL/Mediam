...
@section('content')
    ...
    <div id="banner-area" class="banner-area" style="background-image:url({{ asset($category->big_image->url) }})">
                                            ...
                                            <div class="mb-4 latest-post">
                                                <div class="post-body" style="background-color: F2780C;">
                                                    <h4 class="text-center post-title">
                                                        <a href="{{$category->url}}/{{$post->slug}}" class="d-inline-block"
                                                            style="color: #D93D1A">{{ $post->name }}</a>
                                                    </h4>

                                                    <div class="latest-post-media">
                                                        <a href="{{$category->url}}/{{$post->slug}}" class="latest-post-img">
                                                            <img loading="lazy" src="{{ asset($post->image->url) }}"
                                                                alt="img">
                                                        </a>
                                                    </div>
