        ...
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
            ...
            <div class="flex flex-col flex-1  overflow-x-hidden overflow-y-auto"> 
                    ...
                    <div class="flex items-center justify-between p-2 border-b dark:border-primary-darker">
                        ...
                        <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
                            ...
                            <div class="relative" x-data="{ open: false }">
                                ...
                                <!-- User dropdown menu -->
                                <x-kwd.user-menu></x-kwd.user-menu>
                            </div>
                        </nav>
                ...
                <!-- Main content -->
                    ...
                    <!-- Main footer -->
                    <div class="grid grid-rows-1 grid-flow-col w-full h-full">
                        <footer
                            class="  row-start-3  p-4 bg-white border-t dark:bg-darker dark:border-primary-darker">
                            <div class="grid grid-rows-1 grid-flow-col w-full">
                                <div>CloudOffice &copy; 2022</div>
